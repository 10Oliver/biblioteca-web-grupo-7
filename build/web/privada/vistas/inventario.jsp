                    ...
                    <form action="" method="post">
                        <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            ...
                            <div class="mt-5">
                                ...
                                <div class="my-3">
                                    <div class="flex">
                                        <input type="radio" name="producto" id="libro" class="mr-2" />
                                        <label for="libro">Libro</label>
                                    </div>
                                    <div class="flex">
                                        <input type="radio" name="producto" id="e-book" class="mr-2" />
                                        <label for="e-book">E-book</label>
                                    </div>
                                    <div class="flex">
                                        <input type="radio" name="producto" id="periodico" class="mr-2" />
                                        <label for="periodico">Periodico</label>
                                    </div>
                                    <div class="flex">
                                        <input type="radio" name="producto" id="tesis" class="mr-2" />
                                        <label for="tesis">E-book</label>
                                    </div>
                                    <div class="flex">
                                        <input type="radio" name="producto" id="pelicula" class="mr-2" />
                                        <label for="pelicula">Pelicula</label>
                                    </div>
                                    <div class="flex">
                                        <input type="radio" name="producto" id="cd" class="mr-2" />
                                        <label for="cd">CD</label>
                                    </div>
                                    <div class="flex">
                                        <input type="radio" name="producto" id="revista" class="mr-2" />
                        ...
                        <div class="px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                            ...
                            <button type="submit" class="mt-3 inline-flex w-full justify-center rounded-md border border-transparent bg-blue-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none sm:ml-3 sm:mt-0 sm:w-auto sm:text-sm">Empezar registro del producto</button>
                        </div>
                    </form>
                </div>
            </div>
